...
public class AndroidProcess implements MobileDeviceProcess{
    private String user;
    private String pid;
    private String fullName;

    public AndroidProcess(String user, String pid, String fullName) {
        this.user = user;
        this.pid = pid;
    ...
    public boolean equals(Object o) {
        ...
        AndroidProcess that = (AndroidProcess) o;
